function varargout = phxsim1_mbp(varargin)
% PHXSIM1_MBP M-file for phxsim1_mbp.fig
%      PHXSIM1_MBP, by itself, creates a new PHXSIM1_MBP or raises the existing
%      singleton*.
%
%      H = PHXSIM1_MBP returns the handle to a new PHXSIM1_MBP or the handle to
%      the existing singleton*.
%
%      PHXSIM1_MBP('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in PHXSIM1_MBP.M with the given input arguments.
%
%      PHXSIM1_MBP('Property','Value',...) creates a new PHXSIM1_MBP or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before phxsim1_mbp_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to phxsim1_mbp_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help phxsim1_mbp

% Last Modified by GUIDE v2.5 06-Apr-2010 22:25:35

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @phxsim1_mbp_OpeningFcn, ...
    'gui_OutputFcn',  @phxsim1_mbp_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
% --- Executes just before phxsim1_mbp is made visible.
function phxsim1_mbp_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to phxsim1_mbp (see VARARGIN)

% Choose default command line output for phxsim1_mbp
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes phxsim1_mbp wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = phxsim1_mbp_OutputFcn(hObject, eventdata, handles)
