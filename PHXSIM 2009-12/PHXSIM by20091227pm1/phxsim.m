...
pf_N(77:90)=[1, 1e1, 1e1, 1, 1, 1, 1e2, 1, 1e3, 1e3, 1e3, 1e3, 1e2, 1e2];
pf_I(77:90)=[1,   1,   1, 1, 1, 1,   1, 1, 1e1, 1e2, 1e3, 1e3, 1e2, 1e2];
...
xlabel('delta Mass (above monoisotopic)')
title({[proteinName,' Peptide ',num2str(START),'--',num2str(END)];'Simulated Final H/D Distribution(red) & Convoluted with C13(blue)'})
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%components analysis & plot: refer to msfit6f.m METHOD C(2009-11-09)
...
SaveFileName=[num2str(START) '-' num2str(END) '_phxsim_SaveResults.mat'];
save(SaveFileName,'SaveResults')
disp([SaveFileName, ' has been saved!'])
disp('Program over.');
