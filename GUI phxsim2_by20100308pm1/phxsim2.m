...
obsPeaks_U=phxsim_sim(START,END,Charge,Temp,Time_p,pH_p,QFratio,pf_U,Seq); %call phxsim_sim.m
obsPeaks_I=phxsim_sim(START,END,Charge,Temp,Time_p,pH_p,QFratio,pf_I,Seq);
obsPeaks_N=phxsim_sim(START,END,Charge,Temp,Time_p,pH_p,QFratio,pf_N,Seq);
