%%%2009-12-23 fbmme_hd.m: MATLAB implementation of FBMME_HD.XLS of
%%%Englander Lab for hydrogen exchange rates calculation

function kcHD = fbmme_hd(inputSeq, pDread, TempC, molType, ifCorr)

Temp=TempC+273.15; %convert to kelvin scale

switch ifCorr %need correction or not
    case 1
        pD=pDread+0.4; %pDcorr
    case 0
        pD=pDread;
    otherwise
        error('ifCorr must be 1 or 0!')
end
...
switch molType
    ...
    case 'oligo'
        ...
        Kw=Kw_oligo;
    otherwise
        error('Unknown molType!(must be "poly" or "oligo")')
end
...
Factors_values=[0,0,0,0;...
    ...
    0,0.293000000000000,0,-0.197000000000000;]; %//above part same with that of FBMME_DH.XLS
